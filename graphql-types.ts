...
export type DossierVerificationExportQuery = (
  ...
  & { dossiers?: Maybe<Array<(
    { __typename?: 'Dossier' }
    & Pick<Dossier, 'companyMarkA' | 'companyMarkB' | 'companyPointsA' | 'companyPointsB' | 'expertMarkA' | 'expertMarkB' | 'expertMarkC' | 'expertPointsA' | 'expertPointsB' | 'finalMark' | 'expertPointsC' | 'id' | 'markDeduction' | 'submittedMark'>
    & { affiliation: (
      { __typename?: 'Affiliation' }
      & Pick<Affiliation, 'tenantName'>
    ), candidate: (
      { __typename?: 'Person' }
      & Pick<Person, 'forename' | 'id' | 'surname'>
      ...
      { __typename?: 'Verification' }
      & Pick<Verification, 'changeGrading' | 'comment' | 'id' | 'verifiedAt'>
      & { participant: (
        { __typename?: 'Participant' }
        & Pick<Participant, 'forename' | 'email' | 'surname' | 'id'>
      ) }
    )>> }
  )>> }
);
...
export type ReadVerificationFeedbackQuery = (
  { __typename?: 'Query' }
  & { verificationFeedback?: Maybe<(
    { __typename?: 'VerificationFeedback' }
    & Pick<VerificationFeedback, 'changeGrading' | 'comment'>
    & { dossier: (
      { __typename?: 'Dossier' }
      & { candidate: (
        { __typename?: 'Person' }
